...
| Option | Why rejected |
|---|---|
| Keep Kubernetes as the recommended path | Imposes operator burden (cluster, kubelet, control plane) on every Zakuro consumer. Goes against the "decorate a function, ship it" pitch in [PRD.md](https://github.com/zakuro-ai/zakuro/blob/master/PRD.md). |
