...
def test_default_compute():
    ...
    assert compute.host == "my.zakuro-ai.com", f"Expected my.zakuro-ai.com, got {compute.host}"
    assert compute.port == 9000, f"Expected port 9000, got {compute.port}"
    assert compute.uri == "zc://my.zakuro-ai.com:9000", f"Expected zc://my.zakuro-ai.com:9000, got {compute.uri}"
...
if __name__ == "__main__":
    ...
    print(f"  - API: my.zakuro-ai.com:9000")
